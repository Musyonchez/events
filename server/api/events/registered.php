...
try {
    ...
    send_success('Registered events fetched successfully', 200, ['events' => $events, 'total' => $total]);

} catch (Exception $e) {
    send_error('An error occurred while fetching registered events: ' . $e->getMessage(), 500);
}